...
router.post(
  ...
  body("price")
    ...
    .withMessage("El precio del producto no puede ser 0 o negativo"),
  handleInputErrors,
  createProduct
);

// PUT/PATCH Routes /api/products
/**
 * @swagger
 * /api/products/{id}:
 *  put:
...
router.put(
  ...
  body("availability").isBoolean().withMessage("Disponibilidad inválida"),
